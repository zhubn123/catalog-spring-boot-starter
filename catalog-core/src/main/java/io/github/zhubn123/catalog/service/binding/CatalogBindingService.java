package io.github.zhubn123.catalog.service.binding;
 ...
 * 负责业务对象与目录节点之间的绑定逻辑。
 */
public final class CatalogBindingService {

    private final CatalogRelMapper relMapper;

    public CatalogBindingService(CatalogRelMapper relMapper) {
    ...
    public Long resolveSingleBoundNodeId(String bizId, String bizType) {
        String normalizedBizId = trimToNull(bizId);
        String normalizedBizType = trimToNull(bizType);
